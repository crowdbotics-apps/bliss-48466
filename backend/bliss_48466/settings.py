"""
Django settings for bliss_48466 project.
...
WSGI_APPLICATION = 'bliss_48466.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Bliss Support <support@bliss-48466.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bliss_48466 API",
    "DESCRIPTION": "API documentation for bliss_48466 App",
    "VERSION": "v1",
}
